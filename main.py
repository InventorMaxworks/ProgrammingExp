...
def main():
    ...
    while continueApplication == True:
        ...
        # Listing Pakuri
        if response == 1:
            speciesArray = pakudex.getSpeciesArray()
        ...
        # Add Pakuri
            ...
            methodAnswer = pakudex.addPakuri(species)
        ...
        # Evolve Pakuri
            ...
            methodAnswer = pakudex.evolveSpecies(species)
            if methodAnswer == True:
